...
const AdminPricingBahiaPrincipePage = () => {
    const hotelSlug = 'bahia-principe-punta-cana';
    const hotelName = 'Bahia Principe Punta Cana';
...
export default AdminPricingBahiaPrincipePage;